...
/**
 * swap_ints - two integers are sorted in an array.
...
/**
 * bitonic_merge - a bitonic sequence is sorted inside an array of integers.
 ...
 * @flow: direction in which the bitonic sequence block is sorted.
 */
void bitonic_seq(int *array, size_t size, size_t start, size_t seq, char flow)
{
	size_t cut = seq / 2;
...
/**
 * bitonic_sort - an array of integers is sorted in ascending
 *                order using the bitonic sort algorithm.
 * @array: An array of integers.
 * @size: size of the array.
 *
 * Description: the array after each swap is printed. Only works for
